 ...
 */
final class Version20250211170852 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz ADD options TEXT DEFAULT NULL, DROP option_a, DROP option_b, DROP option_c, DROP option_d');
    }
}
