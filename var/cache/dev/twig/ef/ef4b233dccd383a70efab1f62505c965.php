...
class __TwigTemplate_32609c8627ff0dfe3fec071bb17bc151 extends Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["workshop"]) {
            ...
            yield "                <div class=\"col-lg-4 col-md-6 mb-4\">
                    <div class=\"card shadow-lg border-2 rounded-lg p-3\">
                        ...
                        <a href=\"";
            // line 31
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("atelier_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["workshop"], "id", [], "any", false, false, false, 31)]), "html", null, true);
            yield "\">
                            <img src=\"";
            // line 32
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/images/" . CoreExtension::getAttribute($this->env, $this->source, $context["workshop"], "image", [], "any", false, false, false, 32))), "html", null, true);
            yield "\" class=\"card-img-top img-fluid rounded\" alt=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["workshop"], "titre", [], "any", false, false, false, 32), "html", null, true);
            yield "\">
                        </a>
                        <div class=\"card-body text-center\">
                            <h5 class=\"card-title font-weight-bold\">";
            // line 35
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["workshop"], "titre", [], "any", false, false, false, 35), "html", null, true);
            yield "</h5>
                            <p class=\"card-text\"><strong>Catégorie :</strong> <span class=\"text-muted\">";
            // line 36
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["workshop"], "categorie", [], "any", false, false, false, 36), "nom", [], "any", false, false, false, 36), "html", null, true);
            yield "</span></p>
                        </div>
                    </div>
...
";
    ...
    {
        return array (  168 => 45,  159 => 41,  157 => 44,  148 => 36,  144 => 35,  136 => 32,  132 => 31,  120 => 21,  115 => 20,  111 => 18,  98 => 17,  77 => 4,  64 => 3,  41 => 1,);
    }
...
", "atelier/index.html.twig", "C:\\project\\symfony\\PROJETPI\\TuniVibe\\templates\\atelier\\index.html.twig");
    }
}
